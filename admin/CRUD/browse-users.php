...
<body>	
	<?php
	$condition	=	'';
	if(isset($_REQUEST['MaKhoaHoc']) and $_REQUEST['MaKhoaHoc']!=""){
		$condition	.=	' AND MaKhoaHoc LIKE "%'.$_REQUEST['MaKhoaHoc'].'%" ';
	}
	if(isset($_REQUEST['TenKhoaHoc']) and $_REQUEST['TenKhoaHoc']!=""){
		$condition	.=	' AND TenKhoaHoc LIKE "%'.$_REQUEST['TenKhoaHoc'].'%" ';
	}
						...
						<div class="row">
							<div class="col-sm-2">
								<div class="form-group">
									...
									<input type="text" name="MaKhoaHoc" id="MaKhoaHoc" class="form-control" value="<?php echo isset($_REQUEST['MaKhoaHoc'])?$_REQUEST['MaKhoaHoc']:''?>" placeholder="Enter user name">
								</div>
							</div>
							<div class="col-sm-2">
								<div class="form-group">
									<label>User Email</label>
									<input type="email" name="TenKhoaHoc" id="TenKhoaHoc" class="form-control" value="<?php echo isset($_REQUEST['TenKhoaHoc'])?$_REQUEST['TenKhoaHoc']:''?>" placeholder="Enter user email">
								</div>
							</div>
							<div class="col-sm-2">
								<div class="form-group">
		...
		<div>
			<table class="table table-striped table-bordered">
				...
				<tbody>
					...
					<tr>
						<td><?php echo $s;?></td>
						<td><?php echo $val['MaKhoaHoc'];?></td>
						<td><?php echo $val['TenKhoaHoc'];?></td>
