                ...
                <div class="table-responsive">
                    <div class="table-wrapper">
                        <div class="table-title">
                            <div class="row">
                                <div class="col-sm-6">
                                    <h2>Quản lý <b>chi tiết hóa đơn</b></h2>
                                </div>
                                <div class="col-sm-6">
                        ...
                        <table class="table table-striped table-hover" id="myTable">
                            ...
                            <tbody>
                                ...
                                if (!empty($name)) {
                                    $sql = 'SELECT * FROM chitiethoadon WHERE machitiethoadon LIKE "%' . $name . '%"';
                                } else {
                                ...
                                ?>
                                        <tr id="<?php echo $row["machitiethoadon"]; ?>">
                                            <td>
                                                <span class="custom-checkbox">
