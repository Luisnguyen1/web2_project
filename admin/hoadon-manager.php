...
if(isset($_REQUEST['updateOpt']) && isset($_REQUEST['trangthaiOpt'])){
    $sql = "UPDATE hoadon SET trangthai = '".$_REQUEST['trangthaiOpt']."' WHERE mahoadon = '".$_REQUEST['IDproduct']."'";
        if ($conn->query($sql) === TRUE) {
            echo "<script>alert('Sửa trạng thái thành công!');</script>";
          } else {
            echo "<script>alert('Sửa trạng thái xảy ra lỗi!');</script>";
        }        
}
?>
<!DOCTYPE html>
                    ...
                    <div class="table-wrapper">
                        ...
                        <table class="table table-striped table-hover" id="myTable">
                            ...
                            <tbody>
                                ...
                                if (!empty($name)) {
                                    $sql = 'SELECT * FROM hoadon WHERE mahoadon LIKE "%' . $name . '%"';
                                } else {
                                ...
                                ?>
                                        <tr id="<?php echo $row["mahoadon"]; ?>">
                                            ...
                                            <td>
                                                ...
                                                <input type="hidden" name="IDproduct" value="<?php echo $row["mahoadon"] ?>" />
                                            </td>
                                            <td><?php echo $row["ngayxuat"] ?></td>
                                            <td><?php
                                                $sql1 = "SELECT * FROM khachhang WHERE makhachang = '" . $row["makhachang"] . "'";
                                            ...
                                            <td>
                                                <select id="trangthaiOpt" name="trangthaiOpt">
                                            ...
                                            <td>
                                                <button name="updateOpt" class="btn btn-outline-secondary btn-sm btn-block mb-2" type="submit">
