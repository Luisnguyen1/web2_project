                                ...
                                <div class="card-body">
                                    <form method="GET" action="" class="form" enctype="multipart/form-data">
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-floating">
                                                    <input class="form-control" id="inputLastName" type="text" name="inputLastName" placeholder="Enter your last name" required/>
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-floating mb-3 mb-md-0">
                                                    <input class="form-control" id="inputType" type="type" name="inputType" value="<?php echo $type?>" readonly />
                                                    <label for="inputType">Loại tài khoản</label>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row mb-3">
                                        ...
                                        <div class="mt-4 mb-0">
                                            <div class="d-grid"><input class="btn btn-primary btn-block" type="submit" name="submit" ></div>
                                        </div>
                                    </form>
                                </div>
            ...
            <footer class="py-4 bg-light mt-auto">
                <div class="container-fluid px-4">
                    <div class="d-flex align-items-center justify-content-between small">
                        <div class="text-muted">Copyright &copy; VM School 2024</div>
                        <div>
